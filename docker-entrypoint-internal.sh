...
# Generate env-config.js from environment variables for Internal
cat > /usr/share/nginx/html/admin/env-config.js << EOF
window._env_ = {
...
echo "Generated env-config.js for Internal app with environment variables"
