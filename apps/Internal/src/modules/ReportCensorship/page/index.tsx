...
const ReportCensorshipPage = () => {
  const [searchParams] = useSearchParams();
  const params = decodeSearchParams(searchParams);
  const { data: content, isLoading } = useGetContentReport({
    ...queryParams({
      ...params,
    }),
  });
  ...
  return (
    <Wrapper>
      <TitleHeader>Báo cáo kiểm duyệt</TitleHeader>
      <Header />
...
export default ReportCensorshipPage;
