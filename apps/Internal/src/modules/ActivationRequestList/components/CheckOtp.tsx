...
import { useGetOtp } from '../queryHook/useGetOtp';
import { useConfirmOtp } from '../queryHook/useConfirmOtp';
import { AnyElement, FieldErrorsType, OptionsType } from '@react/commons/types';
import { useActiveSubscriptStore } from '../store';
import { SignEnum, useGenContractNo } from '../queryHook/useGenContractNo';
...
const CheckOtp: React.FC<Props> = ({ typeModal }) => {
  ...
  const { mutate: mutateGenContractNo } = useGenContractNo(form, typeModal);
  const [checkSenOtp, setCheckSenOtp] = useState<boolean>(false);

  if (isSuccessCheckCondition && isSignAgainFlag) {
          ...
          <fieldset>
            ...
            <Row gutter={12}>
              ...
              <Col span={12}>
                ...
                >
                  <CInput
                    disabled={isShowSignLink || !checkSenOtp}
