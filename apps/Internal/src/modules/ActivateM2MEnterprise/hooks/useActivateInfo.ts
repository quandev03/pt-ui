  ...
  return useMutation({
    ...
    onSuccess: (data: any) => {
      ...
      if (
        ...
        NotificationError(location.pathname === pathRoutes.activationRequestListCreate ? 'User không có quyền tạo yêu cầu kích hoạt lớn hơn 3 thuê bao trên 1 GTTT' : 'User không có quyền kích hoạt lớn hơn 3 thuê bao');
      } else {
