...
import { useSubscriberMutation } from '../hooks/useSubscriberMutation';
...
const mapImpactTypeToText = (type: ImpactType) => {
  switch (type) {
...
const SubscriberModal: React.FC<ModalProps> = ({ isOpen, setIsOpen }) => {
  ...
  const handleFinish = (values: any) => {
    const newValues = { ...values, subId: subscriberId };
      ...
      >
        ...
        {isShowMessage && (
          <Form.Item
            ...
            rules={[validateForm.required]}
          >
            <CTextArea placeholder="Nhập nội dung tin nhắn" maxLength={320} />
          </Form.Item>
        )}
      </Form>
    </CModal>
