...
} from 'apps/Internal/src/hooks/useGetApplicationConfig';
    ...
    <fieldset className="bg-white">
                ...
                {location.pathname !==
                  ...
                  <Col span={12}>
                    <Upload
                      ...
                      maxCount={1}
                    >
                      <Button disabled={!isSuccessIsdn} className="w-[8.5rem]">
                        Tải ảnh lên
                      </Button>
                    </Upload>
                  </Col>
              ...
              {location.pathname !== pathRoutes.activationRequestListCreate && (
                <Col span={4}>
                  <Upload
                    ...
                    maxCount={1}
                  >
                    <Button disabled={isInvalidIsdn} className="w-[8.5rem]">
                      Tải ảnh lên
                    </Button>
                  </Upload>
                </Col>
      ...
      {isOpenPdf && (
        <ModalPdf
          ...
          isSign={true}
          contractType={ContractTypeEnum.ND13}
          isND13={true}
        />
      )}
    </fieldset>
