...
export interface IActiveSubscriptStore {
  ...
  isdnSuccess: boolean;
  setSuccessIsdn: (data: any) => void;
  activeKeyStatus: string;
  setActiveKeyStatus: (data: string) => void;
  isSignCommitSuccess: boolean;
  setSignCommitSuccess: (data: boolean) => void;
  isDisabledCommit: boolean;
  setIsDisabledCommit: (isChanged: boolean) => void;
  isClickCommit: boolean;
  setIsClickCommit: (isChanged: boolean) => void;
  // isReset: boolean;
  // setReset: (value: boolean) => void;
  isSignOffline: boolean;
  setIsSignOff: (isChanged: boolean) => void;
  isEnableContract: boolean;
  setIsEnableContract: (data: boolean) => void;
  isEnableCommit: boolean;
  setIsEnableCommit: (data: boolean) => void;
}
...
const useActiveSubscriptStore = create<IActiveSubscriptStore>((set) => ({
  ...
  isDisabledCommit: true,
  setIsDisabledCommit(value) {
    set(() => ({ isDisabledCommit: value }));
  },
  isResetImage: false,
  ...
  isdnSuccess: false,
  setSuccessIsdn(value) {
    set(() => ({ isdnSuccess: value }));
  },
  activeKeyStatus: '0',
  setActiveKeyStatus(value) {
    set(() => ({ activeKeyStatus: value }));
  },
  isSignCommitSuccess: false,
  setSignCommitSuccess(value) {
    set(() => ({ isSignCommitSuccess: value }));
  },
  isClickCommit: false,
  setIsClickCommit(value) {
    set(() => ({ isClickCommit: value }));
  },
  isSignOffline: false,
  setIsSignOff(value) {
    set(() => ({ isSignOffline: value }));
  },
  isEnableCommit: false,
  setIsEnableCommit(value) {
    set(() => ({ isEnableCommit: value }));
  },
  isEnableContract: false,
  setIsEnableContract(value) {
    set(() => ({ isEnableContract: value }));
  },
  // isReset: false,
  // setReset: (value: boolean) => void;
}));
