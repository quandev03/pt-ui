...
const CriteriaConfig = () => {
  ...
  const { mutate: editStatus } = useEditStatus(
    REACT_QUERY_KEYS.GET_CRITERIA_CONFIG_LIST
  );
  ...
  return (
    <>
      <strong className="text-[15px]">Quản lý cấu hình 8 tiêu chí</strong>
      <CTable 
        className="mt-3 pb-5" 
        columns={columns} 
