...
import { useArea } from 'apps/Internal/src/hooks';
...
const Address = () => {
  ...
  useEffect(() => {
    if (actionMode === IModeAction.READ && optionsProvinces.length > 0) {
  ...
  useEffect(() => {
    if (actionMode === IModeAction.READ && optionsDistricts.length > 0) {
