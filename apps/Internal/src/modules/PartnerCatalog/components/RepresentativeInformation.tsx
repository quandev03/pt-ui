...
const RepresentativeInformation = () => {
  ...
  const disableIdCardFrontSite = useMemo(() => {
    ...
    return actionMode === IModeAction.READ || idCardFrontSite;
  ...
  const disableIdCardBackSite = useMemo(() => {
    ...
    return (
      actionMode === IModeAction.READ || !idCardFrontSite || idCardBackSite
    );
  ...
  const disablePortrait = useMemo(() => {
    ...
    return actionMode === IModeAction.READ || !idCardBackSite || portrait;
