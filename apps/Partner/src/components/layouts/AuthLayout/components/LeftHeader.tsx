import MenuFoldOutlined from 'apps/Partner/src/assets/images/MenuFoldOutlined.svg';
import MenuUnfoldOutlined from 'apps/Partner/src/assets/images/MenuUnfoldOutlined.svg';
