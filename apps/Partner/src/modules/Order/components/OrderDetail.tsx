...
} from 'apps/Partner/src/hooks/useReasonCatalogService';
import validateForm from 'apps/Partner/src/utils/validator';
import { memo, useEffect, useMemo } from 'react';
import { useArea } from '../queryHooks';
...
const OrderDetail = () => {
  ...
  const { SALE_ORDER_SHIPPING_METHOD = [], SALE_ORDER_PAYMENT_OPTION = [] } =
      ...
      <Col span={12}>
        ...
        >
          <CInput
            ...
            disabled={actionMode === ACTION_MODE_ENUM.VIEW}
            onBlur={(e) => {
              const value = form.getFieldValue('customerAddress') ?? '';
              form.setFieldValue('customerAddress', value.trim());
            }}
          />
        </Form.Item>
      </Col>
