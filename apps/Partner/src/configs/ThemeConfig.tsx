...
export const ThemeColors: ThemesType = {
  primary: '#005AAA',
  secondary: '#002046',
  textGray: '#333333',
  buttonPrimary: 'rgba(255, 204, 99, 1)',
  primaryHover: '#076AB3',
  ...
  activeButton: '#076AB3',
  menuBackground: 'rgba(7, 106, 179, 0.71)',
  ...
  statusGreen: '#128300',
  statusRed: '#E51616',
  statusGreenHover: '#18af007a',
  statusRedHover: '#ff0213d1',
  statusNotSync: '#F6D300',
  statusYellow: '#FF9900',
  statusBlue: '#1365E1',
  tableSelectedActive: '#fbfbfb',
...
export const themeConfig: ThemesType = {
  primary: '#005AAA',
  secondary: '#002046',
  textGray: '#333333',
  buttonPrimary: 'rgba(255, 204, 99, 1)',
